...
def main():
    ...
    heuristics = {}
    heuristics['Bogota'] = 0
    heuristics['Facatativa'] = 137
    heuristics['Honda'] = 137
    heuristics['Ibague'] = 114
    heuristics['Manizales'] = 211
    heuristics['Medellin'] = 0
    heuristics['Melgar'] = 86
    heuristics['Pereira'] = 238
    heuristics['Puerto Berrio'] = 172
    heuristics['Tunja'] = 239
